...
export const SITE_DESCRIPTION =
  "Medon Company is headquartered in Mahipalpur, Delhi — providing expert AC repair, refrigerator service, electrical & geyser repair across Delhi NCR. Verified technicians, transparent pricing, same-hour service in Mahipalpur.";
