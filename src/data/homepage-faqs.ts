...
export const HOMEPAGE_FAQS = [
  {
    question: "What is the cost of AC repair in Delhi?",
    answer:
      "AC repair in Delhi starts from ₹199 for a general inspection. Gas refilling costs ₹999–₹2,999 depending on the refrigerant type, and compressor repairs start from ₹2,500. We provide transparent, upfront pricing with no hidden charges.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, all repairs come with a 90-day service warranty. Parts replacements carry the manufacturer's warranty. If any issue recurs within the warranty period, we'll fix it at no additional cost.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We repair all major AC brands including Daikin, LG, Samsung, Voltas, Blue Star, Hitachi, Carrier, Panasonic, Godrej, Lloyd, and more. Our technicians are trained to handle both split and window AC units of all tonnages.",
  },
  {
    question: "Do you provide emergency AC repair near Delhi Airport?",
    answer:
      "Yes, we provide 24/7 emergency AC repair for hotels and businesses in the Delhi Airport zone including Aerocity, Mahipalpur, and Dwarka. For residential customers, emergency service is available from 8 AM to 10 PM with under 1-hour response time.",
  },
];
